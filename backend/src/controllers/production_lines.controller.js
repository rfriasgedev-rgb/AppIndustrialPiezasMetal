...
exports.getAll = async (req, res) => {
    try {
        ...
        const [lineEmployees] = await db.query(`
...
exports.create = async (req, res) => {
    ...
    try {
        ...
        const [result] = await connection.query(`
            INSERT INTO production_lines (name, description, leader_employee_id) 
            VALUES (?, ?, ?)
...
exports.delete = async (req, res) => {
    try {
        const [result] = await db.query('DELETE FROM production_lines WHERE id = ?', [req.params.id]);
